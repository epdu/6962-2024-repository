...
//            if (scoringArm.wrist.isWristTransferring) {scoringArm.wrist.setWristStow();}
...
//
//            scoringArm.arm.transferArm();                 // flip arm over
//            scoringArm.claw.closeClaw();                   // grab sample
//            scoringArm.arm.stowArm();                     // remove piece from intake
